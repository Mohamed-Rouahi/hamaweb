...
class ReclamationController extends AbstractController
{
    ...
    public function new(FlashyNotifier $flashy, Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $file = $request->files->get('reclamation')['imagereclamtion'];
     ...
     */
    public function edit(FlashyNotifier $flashy, Request $request, Reclamation $reclamation, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(ReclamationType::class, $reclamation);
        $form->handleRequest($request);
     ...
     */
    public function delete(FlashyNotifier $flashy, Request $request, Reclamation $reclamation, EntityManagerInterface $entityManager): Response
    {
